<template>
    <div class="flex items-center gap-5 mb-8">
        <svg @click="closeDrawer"
            class="opacity-30 cursor-pointer transition hover:-translate-x-1 rotate-180 hover:opacity-100" width="20"
            height="18" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
